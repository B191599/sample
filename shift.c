...
while (1)
{
// If there are more characters in the input string, add the
//next character to the stack
if (i < strlen(input))
{
ch[0] = input[i];
ch[1] = '\0';
...
/* Check if the stack contains only the start symbol and if theentire input string has been processed */
